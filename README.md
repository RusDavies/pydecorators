...
Then read the per-decorator docs and [decorator stacking guidance](https://github.com/RusDavies/pydecorators/blob/master/docs/composition.md) before stacking decorators together. Decorator soup is still soup, even when typed.
...
See the [release checklist](https://github.com/RusDavies/pydecorators/blob/master/RELEASE.md) before cutting a package release.

## Decorator design docs

PyPI renders these as normal outbound links, not local Markdown file references:

- [Cache decorator design](https://github.com/RusDavies/pydecorators/blob/master/docs/cache_result.md)
- [Retry behavior](https://github.com/RusDavies/pydecorators/blob/master/docs/retry.md)
- [Rate limiting](https://github.com/RusDavies/pydecorators/blob/master/docs/rate_limit.md)
- [Async timeout behavior](https://github.com/RusDavies/pydecorators/blob/master/docs/timeout.md)
- [Call logging](https://github.com/RusDavies/pydecorators/blob/master/docs/log_calls.md)
- [Timing hooks](https://github.com/RusDavies/pydecorators/blob/master/docs/measure_time.md)
- [Runtime type validation](https://github.com/RusDavies/pydecorators/blob/master/docs/validate_types.md)
- [Environment checks](https://github.com/RusDavies/pydecorators/blob/master/docs/require_env.md)
- [Circuit-breaker behavior](https://github.com/RusDavies/pydecorators/blob/master/docs/circuit_breaker.md)
- [Decorator stacking guidance](https://github.com/RusDavies/pydecorators/blob/master/docs/composition.md)
- [Compact API reference](https://github.com/RusDavies/pydecorators/blob/master/docs/API_REFERENCE.md)
...
See [security hardening checklist](https://github.com/RusDavies/pydecorators/blob/master/docs/security_hardening.md) for the centralized hardening checklist.
